...
Tokens are generated by `telahubd` and are shared out-of-band (for example, via a password manager or secrets vault). For a detailed explanation of how tokens, roles, and machine permissions interact, see [ACCESS-MODEL.md](ACCESS-MODEL.md).
...
See [ACCESS-MODEL.md](ACCESS-MODEL.md) for the complete access model reference, including how tokens, roles, and machine permissions interact.
