...
The body of this chapter is currently the path-gateway design rationale and predates the gateway-primitive reframe. Wave 3 of the book reorganization will distill this chapter to cover the family as a whole; for now, read it as the rationale for the L7 instance with the awareness that the same rule applies at L4 (twice) and L3.
