...
Running WireGuard in userspace is what makes Tela work without admin rights, kernel drivers, or TUN devices. It comes with real tradeoffs. An optional kernel TUN mode that removes most of these limitations is [on the roadmap](ROADMAP-1.0.md#kernel-tun-mode-exit-node-full-ip-routing) as a post-1.0 feature.
