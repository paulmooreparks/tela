...
See [Run a hub on the public internet](hub.md) for the full deployment walkthrough, including TLS configuration and service installation. For a quick test on a host with a public address:
