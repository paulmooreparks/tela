...
| `hubRole` | no | `owner` (full control), `admin` (can manage tokens), or empty string (regular user) |
...
Once bootstrapped, use `tela admin` commands to manage tokens remotely — no shell access to the hub needed.
